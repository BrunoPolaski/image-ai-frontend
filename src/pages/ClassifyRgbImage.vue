    ...
    <q-page class="column flex-center">
        ...
        <q-card class="bg-grey-2 bordered column flex-center width-50" style="min-height: 600px;">
            <div class="row flex-center q-ma-md">
                <CharacteristicInput
                    v-for="(characteristic, index) in modelStore.characteristics"
                    :key="index"
            ...
            <PrimaryButton
                ...
                icon="category"
                rounded
                @click="modelStore.classifyImageRgb(modelName)"
            />
        </q-card>
...
onBeforeMount(() => {
    modelStore.dialogOpen = false;
    modelStore.image = {} as File;
});
